...
$class_name = 'professional_section';
...
?>
<section <?php echo esc_attr( $anchor ); ?>class="<?php echo esc_attr( $class_name ); ?>" style="background-color: <?php echo $background_color; ?>">
  <div class="professional_section-inner<?php echo $bottom_padding; echo $top_padding; ?>" style="<?php echo 'max-width:' . $theme_settings['wide_size'] . ';';?>">
    <div class="row">
    <div class="col-md-6">
        <?php
          if( !empty( $image ) ): ?>
